...
#define CHOICES_CONSUMER_BOUND No, Basic, Updated, Single, Single_Edits_Sparse, Single_First, Single_First_Edits_Sparse, Single_Heur
...
#define CHOICES_CONSUMER_SELECTOR First, Least, Single, Single_Edits_Sparse, Single_First, Single_First_Edits_Sparse, Single_Heur
#define CHOICES_CONSUMER_BOUND No, Basic, Updated, Single, Single_Edits_Sparse, Single_First, Single_First_Edits_Sparse, Single_Heur
#define CHOICES_CONSUMER_RESULT
#define CHOICES_GRAPH Matrix
#endif
