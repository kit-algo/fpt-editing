#ifndef FINDER_CENTER_EDITS_SPARSE_OLD_HPP
#define FINDER_CENTER_EDITS_SPARSE_OLD_HPP
...
namespace Finder
{
	...
	class Center_Edits_Sparse_Old
	{
		static_assert(_length > 3, "Can only detect path/cycles with at least 4 vertices");

	public:
		static constexpr char const *name = "Center_Edits_Sparse_Old";
	...
	public:
		Center_Edits_Sparse_Old(VertexID graph_size) : forbidden(Graph::alloc_rows(graph_size, length / 2 - 1)), offered(graph_size) {;}
	...
	class Center_Edits_Sparse_Old_4 : public Center_Edits_Sparse_Old<Graph, Graph_Edits, Mode, Restriction, Conversion, 4>
	{
	private: using Parent = Center_Edits_Sparse_Old<Graph, Graph_Edits, Mode, Restriction, Conversion, 4>;
	public:
		static constexpr char const *name = "Center_Edits_Sparse_Old_4";
		Center_Edits_Sparse_Old_4(VertexID graph_size) : Parent(graph_size) {;}
	};

	template<typename Graph, typename Graph_Edits, typename Mode, typename Restriction, typename Conversion>
	class Center_Edits_Sparse_Old_5 : public Center_Edits_Sparse_Old<Graph, Graph_Edits, Mode, Restriction, Conversion, 5>
	{
	private: using Parent = Center_Edits_Sparse_Old<Graph, Graph_Edits, Mode, Restriction, Conversion, 5>;
	public:
		static constexpr char const *name = "Center_Edits_Sparse_Old_5";
		Center_Edits_Sparse_Old_5(VertexID graph_size) : Parent(graph_size) {;}
	};
