...
namespace Finder
{
	...
	public:
		Center_Edits(Graph const &graph) : forbidden(graph.alloc_rows(length / 2 - 1)) {;}
	...
	public:
		...
		Center_Edits_4(Graph const &graph) : Parent(graph) {;}
	};
	...
	public:
		...
		Center_Edits_5(Graph const &graph) : Parent(graph) {;}
	};
