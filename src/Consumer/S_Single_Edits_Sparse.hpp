#ifndef CONSUMER_SELECTOR_SINGLE_EDITS_SPARSE_HPP
#define CONSUMER_SELECTOR_SINGLE_EDITS_SPARSE_HPP
...
namespace Consumer
{
	...
	private:
		...
		Finder::Feeder<Finder_impl, Graph, Graph_Edits, Single_Edits_Sparse> feeder;
